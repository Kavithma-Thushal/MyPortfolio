$('.theme-checkbox').click(function () {
    if ($(this).is(':checked')) {
        ...
        /*header*/
        $('header').css('background-color', '#D8DCDE');
        $('#heading1').css('color', 'black');
        $('.menu ul li a').css('color', 'black');

        /*home*/
        $('main > section:nth-child(1)').css('background-color', '#ECF0F3');
        ...
        /*about*/
        $('main > section:nth-child(2)').css('background-color', '#ECF0F3');
        ...
        /*gallery*/
        $('main > section:nth-child(5)').css('background-color', '#ECF0F3');
        $('main > section:nth-child(5) > section:first-child > h1').css('color', 'black');

        /*projects*/
        $('main > section:nth-child(6)').css('background-color', '#ECF0F3');
        $('main > section:nth-child(6) > section:first-child > h1').css('color', 'black');

        /*contacts*/
        $('main > section:nth-child(7)').css('background-color', '#ECF0F3');
        ...
        /*home*/
        $('main > section:nth-child(1)').css('background', 'url(assets/img/background.mp4) no-repeat');
        ...
        /*about*/
        $('main > section:nth-child(2)').css('background', 'url(assets/img/background.mp4) no-repeat');
        ...
        /*services*/
        $('main > section:nth-child(3)').css('background', 'url(assets/img/background.mp4) no-repeat');
        $('main > section:nth-child(3) > section:first-child > h1').css('color', 'white');

        /*skills*/
        $('main > section:nth-child(4)').css('background', 'url(assets/img/background.mp4) no-repeat');
        $('main > section:nth-child(4) > section:first-child > h1').css('color', 'white');

        /*gallery*/
        $('main > section:nth-child(5)').css('background', 'url(assets/img/background.mp4) no-repeat');
        $('main > section:nth-child(5) > section:first-child > h1').css('color', 'white');

        /*projects*/
        $('main > section:nth-child(6)').css('background', 'url(assets/img/background.mp4) no-repeat');
        $('main > section:nth-child(6) > section:first-child > h1').css('color', 'white');

        /*contacts*/
        $('main > section:nth-child(7)').css('background', 'url(assets/img/background.mp4) no-repeat');
